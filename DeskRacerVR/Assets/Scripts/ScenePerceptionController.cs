...
public class ScenePerceptionController : NetworkBehaviour
{
    //[SerializeField]
    ...
    public void TakeNewConnector(Player player)
    {
        _leftController = player.GetLeftController();
        _rightController = player.GetRightController();
        _anchorDisplayRight = player.GetAnchorDisplayRight();
